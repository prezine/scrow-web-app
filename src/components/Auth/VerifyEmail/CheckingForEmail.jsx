...
const CheckingForEmail = ({id}) => {
    ...
    const [emailVerified, setEmailVerified] = useState(userDataValue && userDataValue.verification_status.email == 1)
    ...
    //         let verified = res.data.data.user.verification_status.email === 1;
    ...
    // const {data, error} = useSWR(`${import.meta.env.VITE_BASEURL}/user/profile/fetch?userID=${userDataValue && userDataValue.userID}`, fetcher)
            ...
            {code}
            {
                ...
                <div className='py-28'>
                    ...
                    <div className='pt-12 text-center w-full'>
                        ...
                        <NavLink to={'/'} className={`flex text-center justify-center bg-brandDarkViolet1x w-full min-w-full text-white py-3 px-6 text-sm md:text-base rounded-ten`}>Continue with Login</NavLink>
                    </div>
                ...
                <div className='py-28'>
                    ...
                    <div className='pt-12 text-center'>
                        ...
                        <p className='text-sm md:text-base pt-5 text-brandGray6x'>We've sent an email to your inbox <span className='font-avenirBlack'>{userDataValue ? userDataValue.email : ''}</span>, Check your email and confirm to activate your account.</p>
                    </div>
...
export default CheckingForEmail